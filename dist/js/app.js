// script.js
    ...
    wiffle.controller('donateController', function($scope, $log, $http, env) {
        ...
        var environment = (env === 'production') ? 'production' : 'sandbox';
...
angular.module("wiffle.config", [])
.constant("env", "dev")
.constant("port", 5000)
.constant("mongoDatabaseName", "dev")
.constant("confirmationEmailTarget", "regdshaner@gmail.com");
